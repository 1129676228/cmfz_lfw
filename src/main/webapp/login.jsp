...
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/Admin/login" method="post" >
				...
				<table>
					<tbody>
					<input type="hidden"  name="id" class="text" value="" maxlength="20"/>
						<tr>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<input type="button" class="homeButton" value="" onclick="location.href='${pageContext.request.contextPath}/main/main.jsp'"><input type="submit" class="loginButton" value="登录">
						</td>
					</tr>
				</tbody></table>
